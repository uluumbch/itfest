                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class=" shadow max-w-md">
                            ...
                            <label for="<?php echo e($item->id); ?>" class="cursor-pointer">
                                ...
                                <div class="">
                                    <div class="max-w-md">
                                        <img src="<?php echo e(asset('images/' . $item->gambar)); ?>" class="w-full select-none"
                                            alt="">
                                    </div>
                                    <div class="text-center">
                                        <p class="font-bold py-6">No. Peserta<?php echo e($item->nomor); ?></p>
                                        <p class="font-bold py-6">No. Peserta<?php echo e($item->nama_gambar); ?></p>
                                        <P class="font-semibold py-3"><?php echo e($item->nama); ?></P>
                                        <P class="font-semibold py-3"><?php echo e($item->desc); ?></P>
...
<?php /**PATH /home/uluumbch/code/itfest/resources/views/vote/drawing.blade.php ENDPATH**/ ?>