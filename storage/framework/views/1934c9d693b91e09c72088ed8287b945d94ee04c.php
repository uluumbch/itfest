...
<head>
    ...
    <title>IT MATSURI | Favorite Drawing</title>
...
<body>
    <section class="bg-itmsecondary">
        <div class="w-[calc(100%_-_10rem)] mx-auto rounded bg-itmprimary py-5">
            ...
            <h6 class="text-xl text-center"> OUR FAVORITE DRAWING</h6>
        </div>
                    ...
                    <?php if($key == 0): ?>
                        <div class=" shadow max-w-md">
                            <div class="">
                                ...
                                <div class="max-w-md">
                                    <img src="<?php echo e(asset('images/' . $item->gambar)); ?>" alt="<?php echo e($item->nama); ?>"
                                        class="w-full">
                                </div>
...
<?php /**PATH /home/uluumbch/code/itfest/resources/views/vote/hasil-draw.blade.php ENDPATH**/ ?>