      ...
      >
        ...
        <div class="flex justify-evenly text-xl">
          ...
          >
            <span>Roadmap</span>
            <div
              class="w-full h-4 left-1 bottom-2 rounded-t-full bg-darkblue absolute <?php echo e((request()->is('itfest/roadmap')) ? 'block' : 'hidden group-hover:block'); ?>"
            ></div>
          </a>
          <a
            class="group p-8 relative hover-trigger transition-opacity duration-700"
          ...
          >
            <span>About</span>
            <div
                class="w-full h-4 left-1 bottom-2 rounded-t-full bg-darkblue absolute <?php echo e((request()->is('itfest/tentang')) ? 'block' : 'hidden group-hover:block'); ?>"
            ></div>
          </a>
        </div>
      </nav>
...
<?php /**PATH C:\laragon\www\midtrans-laravel\resources\views/partials/navbar.blade.php ENDPATH**/ ?>