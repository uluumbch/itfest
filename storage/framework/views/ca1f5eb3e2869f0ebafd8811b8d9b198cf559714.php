  ...
  <body class="scroll-smooth bg-darkblue font-Poppins">
    <div class="h-screen relative w-full overflow-hidden">
      ...
      <div class="hidden lg:block absolute bottom-0 -right-4">
        <img src="<?php echo e(asset('/assets/pacman.png')); ?>" alt="decoration it fest" />
      </div>
    ...
    <section class="">
      <div class="flex justify-between">
        ...
        <div class="w-1/3 my-auto">
          <img src="<?php echo e(asset('/assets/LOGO.png')); ?>" alt="Logo ITFEST PSTI ULM" />
        </div>
    ...
    <section class="flex flex-col mt-5">
      <div class="rounded-full m-auto">
        <img src="<?php echo e(asset('/assets/IO.png')); ?>" alt="MASKOT IO ITFEST 2022" />
      </div>
...
<?php /**PATH C:\laragon\www\midtrans-laravel\resources\views/tentang.blade.php ENDPATH**/ ?>