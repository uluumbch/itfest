                ...
                <div class="my-2 bg-darkblue text-slate-100 rounded-md">
                    <div class="p-5">
                        <div class="flex justify-between">
                            ...
                            <span class="text-lg"><?php echo e($nama); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-lg">Email : </span>
                            <span class="text-lg"><?php echo e($email); ?></span>
                        </div>

                        <div class="flex justify-between">
                            <span class="text-lg">Total Harga : </span>
                            <span class="text-lg"><?php echo e($harga); ?></span>
                        </div>
...
<?php /**PATH C:\laragon\www\midtrans-laravel\resources\views/checkout.blade.php ENDPATH**/ ?>