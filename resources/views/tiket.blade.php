    ...
    @foreach($data as $item)
            <div class="max-w-sm border border-secondary rounded-lg shadow-md bg-accent my-3">
                ...
                <div class="p-5">
                    ...
                    <a href="/itmatsuri/tiket/{{$item->id}}" class="inline-flex bg-darkblue items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Pilih TIket
                    </a>
                </div>
            </div>
