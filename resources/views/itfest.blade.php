...
<body>
  ...
  @include('partials.navbar')
    ...
    <div class="h-screen relative flex justify-between flex-col lg:flex-row mx-auto text-slate-200 overflow-hidden">
      <div class="my-auto mx-auto lg:mx-0 w-3/4 text-center lg:text-left lg:ml-32 lg:mb-14">
        ...
        <div class="absolute hidden lg:block rotate-6 -right-28 bottom-3">
          <img src="{{ asset('assets/LOGO.png') }}" alt="LOGO ITFEST 2022" />
        </div>
      ...
      <div class="absolute hidden lg:block rotate-6 -left-28 top-3">
        ...
        <img src="{{asset('/assets/IO-pose1.png')}}" alt="MASKOT ITFEST 2022" />
      </div>
    </div>
    <!-- icon scroll down -->
    ...
    <div class="overflow-hidden" id="roadmap">
      ...
      <div class="w-full">
        <img src="{{asset('/assets/roadmap.png')}}" alt="Roadmap ITFEST HMTI 2022" class="max-w-5xl w-96 lg:w-full m-auto" />
      </div>
    </div>
    <!-- end section roadmap -->
    ...
    <div
      ...
      <div class="absolute top-10 lg:top-16 right-8">
        <img src="{{asset('/assets/flower.svg')}}" class="w-14" />
      </div>
      <div class="absolute top-1/4 left-8">
        <img src="{{asset('/assets/flower.svg')}}" class="w-14 rotate-[27deg]" />
      </div>
      <div class="absolute bottom-4 lg:bottom-10 right-16">
        <img src="{{asset('/assets/flower.svg')}}" class="w-14 rotate-45" />
      </div>
      <img src="{{asset('/assets/ITMATSURI_RED.png')}}" alt="itmatsuri" class="w-1/2 mx-auto max-w-xs" />
